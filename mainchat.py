...
from bot import (
    ...
    handle_new_search, ask_host_type, handle_host_type, stop, menu, help, handle_problemas1,handle_selected_equipo,
...
def main():
    application = Application.builder().token('7319075472:AAGHNFfervCfH3lt5mblsMoDgjtNQwydlwo').build() #principal
    #application = Application.builder().token('7922038339:AAEK4yUQjh7gMXy0Y3Bi1MqIi_cyuMeRDAo').build() #pruebas
